...
for i, lin in enumerate(linklist, start=1):
    ...
    csvfile = pd.read_csv(filepath, sep=' *; *', usecols=['STATIONS_ID','MESS_DATUM','FX','RSK','TXK', 'TNK'], index_col=False, engine = 'python', 
                          dtype={'STATIONS_ID': 'int32', 'MESS_DATUM': 'int32', 'FX': 'float32', 'RSK': 'float32', 'TXK': 'float32', 'TNK': 'float32'})
